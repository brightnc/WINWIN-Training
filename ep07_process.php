...
$sql = "INSERT INTO user_info(`username`, `password`, `fname`, `lname`, `email`, `id_card`, `phone_number`, `created_at`) VALUES ('{$input_username}', '{$hashed_input_password}', '{$input_f_name}', '{$input_l_name}', '{$input_email}', '{$input_user_id}', '{$input_phone}','{$created_at}')";
